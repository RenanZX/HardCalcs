...
public class Cmat_EscPanel extends javax.swing.JFrame {

    
    public Cmat_EscPanel() {
        initComponents();
    }
    ...
    private void EventEquals(){
        switch(opt){
            ...
            case hardcalcs.Cmat.TAM3X:
                Opt3x();
                break;
            default:/*caso nenhuma opcao seja verdadeira o programa requisitara ao usuario apertar o botao*/
                VisorCalc.setText("Primeiro Selecione o Tamanho");
        }
    }
...
/*funcao run responsavel por criar a janela*/
    public static void run(){
        Cmat_EscPanel c = new Cmat_EscPanel();
